...
INSERT INTO EquipmentType (Name, Description) VALUES
...
(N'Лыжные палки', N'Комплект лыжных палок для горных лыж'),
(N'Сноубордические ботинки', N'Комплект ботинок для сноуборда');
GO
