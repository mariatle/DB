...
VALUES ('New Ski St', '180 cm', 30.0, 'Excellent', 0, '2024-12-01', '2025-12-01', N'1-year full warranty');
...
DELETE FROM EquipmentWithWarranty WHERE EquipmentID = 23;

-- Проверка, что данные удалены из Equipment
SELECT * FROM Equipment WHERE EquipmentID = 23;

-- Проверка, что данные удалены из EquipmentWarranty
SELECT * FROM EquipmentWarranty WHERE EquipmentID = 23;
